...
func TestMigStrategyNone(t *testing.T) {
	...
	conf := Conf{true, true, "none", "./gfd-test-mig-none", time.Second, true}
...
func TestMigStrategySingleForNoMigDevices(t *testing.T) {
	...
	conf := Conf{true, true, "single", "./gfd-test-mig-single-no-mig", time.Second, true}
...
func TestMigStrategySingle(t *testing.T) {
	...
	conf := Conf{true, true, "single", "./gfd-test-mig-single", time.Second, true}
...
func TestMigStrategyMixed(t *testing.T) {
	...
	conf := Conf{true, true, "mixed", "./gfd-test-mig-mixed", time.Second, true}
