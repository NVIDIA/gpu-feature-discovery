...
$ curl https://raw.githubusercontent.com/NVIDIA/gpu-feature-discovery/v0.7.0/deployments/static/gpu-feature-discovery-job.yaml.template \
...
The `helm` chart for the latest release of GFD (`v0.7.0`) includes a number
...
* https://github.com/NVIDIA/gpu-feature-discovery/blob/v0.7.0/deployments/helm/gpu-feature-discovery/values.yaml
* https://github.com/NVIDIA/gpu-feature-discovery/blob/v0.7.0/deployments/helm/gpu-feature-discovery/charts/node-feature-discovery/values.yaml
...
Then verify that the latest release (`v0.7.0`) of the plugin is available:
```
$ helm search repo nvgfd --devel
NAME                          CHART VERSION  APP VERSION    DESCRIPTION
nvgfd/gpu-feature-discovery   0.7.0     0.7.0     A Helm chart for ...
```
...
$ helm upgrade -i nvgfd \
    --set allowDefaultNamespace=true \
    https://nvidia.github.io/gpu-feature-discovery/stable/gpu-feature-discovery-0.7.0.tgz
```
